            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="phone" placeholder="Enter name" required>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="country2" class="h4">Страна Отдыха</label>
                        <input type="text" class="form-control" id="country2" placeholder="Enter email" required>
                    </div>
                </div>
                ...
                <button type="submit" id="form-submit" class="btn btn-danger btn-lg pull-right ">Submit</button>
                <div id="msgSubmit" class="h3 text-center text-hide">Message Submitted!</div>
                </form>
            </div>
        </div>
    </div>
