Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/alwizo.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/alwizo)

## About

I’m a huge fan of Underscores, Bootstrap, and Sass. Why not combine these into a solid WordPress Theme Framework?
That’s what alwizo is. 
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for alwizo.

At the moment, alwizo is in a very early stage. But if you wan’t, feel free to use it for your own WordPress theme!

# alwizo WordPress Theme Framework

Website: [http://alwizo.com](http://alwizo.com)

Child Theme Project: [https://github.com/holger1411/alwizo-child](https://github.com/holger1411/alwizo-child)

## License
alwizo is released under the terms of the GPL version 2 or (at your option) any later version.
...
- Jetpack ready.
- WooCommerce support.
- [Child Theme](https://github.com/holger1411/alwizo-child) ready.
- Translation ready.
...
Some basics about the Sass and CSS files that come with alwizo:
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or alwizo variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "alwizo/alwizo"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the alwizo folder from GitHub or from alwizo.com
- IMPORTANT: If you download it from GitHub make sure you rename the "alwizo-master.zip" file just to "alwizo.zip" or you might have problems using child themes !!
- Upload it into your WordPress installation subfolder here: `/wp-content/themes/`
- Login to your WordPress backend
- Go to Appearance → Themes
- Activate the alwizo theme

## Developing With npm, Gulp and SASS and [Browser Sync][1]

### Installing Dependencies
- Make sure you have installed Node.js and Browser-Sync* (* optional, if you wanna use it) on your computer globally
- Then open your terminal and browse to the location of your alwizo copy
